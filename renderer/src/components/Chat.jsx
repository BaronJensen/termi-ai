        ...
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          <button 
            ...
            style={{
              fontSize: '10px',
              padding: '2px 6px',
              backgroundColor: showSearch ? '#10b981' : '#6b7280',
              color: '#e6e6e6',
              border: 'none',
              borderRadius: '3px',
              cursor: 'pointer'
          ...
          <button
            ...
            aria-label="Copy directory information"
          >
            Copy
          </button>
        </div>
      ...
      {terminalStatus && (
        <div className="copyable-container" style={{ 
          ...
          <div>
            ...
            <button 
              onClick={clearAllToolCallsWithAnimation}
              style={{ 
                padding: '2px 8px', 
                background: '#f59e0b', 
                color: '#e6e6e6', 
            ...
            <button 
              onClick={clearCompletedToolCallsWithAnimation}
              style={{ 
                padding: '2px 8px', 
                background: '#10b981', 
                color: '#e6e6e6', 
              ...
              title="Clear only completed tool calls"
            >
              Clear Completed
            </button>
            <button 
              onClick={forceClearAllToolCalls}
              style={{ 
                padding: '2px 8px', 
                background: '#ef4444', 
                color: '#e6e6e6', 
              ...
              title="Force clear all tool calls immediately"
            >
              Force Clear All
            </button>
          </div>
